...
export const invoices = pgTable("Invoice", {
  ...
  ppnAmount: doublePrecision("ppnAmount").notNull(),
  totalAmount: doublePrecision("totalAmount").notNull(),
  poContractNo: text("poContractNo"),
  deliveredTo: text("deliveredTo"),
  paidToBankName: text("paidToBankName"),
  paidToAccountNumber: text("paidToAccountNumber"),
  paidToAccountName: text("paidToAccountName"),
  notes: text("notes"),
